...
```bash
curl -fsSL https://raw.githubusercontent.com/laughing-glitch/article-visual-planner-skill/main/bootstrap.sh | bash
```
...
- 已经生成过的图片会自动跳过，不会重复花费额度。
- 可以设置本次最多提交几次付费请求，例如 `--max-paid-requests 1`。
