...
- Multiple article illustrations with one unified ratio, default `16:9`
...
- Recommended number of article illustrations
...
- Generate one image for each cover or article-illustration prompt section.
